...
Iterating over nested objects in JavaScript is quite difficult because it
is difficult to follow the tree of properties all the way down to remember where
results are being stored. 
Were you able to find useful methods to help you with this?
We were able to use the hasOwnProperty method to pass data between objects.
What concepts were solidified in the process of working through this challenge?
This challenge should have solidified the concept of iterating over nested objects in JavaScript,
but I think my pairing partner and I are still confused about how we made these functions
work.
*/

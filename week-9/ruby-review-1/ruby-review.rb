...
# Are there any more methods needed in this class?
  ...
  def remove_item(item = @contents.pop) #what is `#pop` doing? removing the last item (the one added in the prior method)
    @contents.delete(item)
  end

  def dump
    @contents = [] # what should this method return? an empty array
    puts "Your drawer is empty."
  end
...
# Are there any more methods needed in this class? we added #clean_silverware to match the driver code
...
We reviewed debugging and creating class methods in this challenge.
What is still confusing to you about Ruby?
I am finding Ruby to be less confusing as Phase 0 concludes; the process of refactoring
and all of the different ways to iterate in Ruby (which we didn't review in this challenge) are still confusing to me.
What are you going to study to get more prepared for Phase 1? 
I am going to do some of the more complex Ruby review challenges and study JavaScript syntax especially.
